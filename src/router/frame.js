...
const routes = [
    {
        ...
        children: [
                ...
                children: [
                    {
                        ...
                        meta: {
                            icon: "UserFilled",
                            text: "Personal attendance",  //个人考勤"
                            permissions: [PermissionChoices.Staff],   // 所有人均可以访问
                            opt: "|"
                        }
                    },
                    {
                        ...
                        meta: {
                            icon: "User",
                            text: "Subordinate attendance",  //下属考勤
                            permissions: [PermissionChoices.Boarder, PermissionChoices.Leader],  // 只有董事会成员或者部门leader才可以
                            opt: "|"
                        }
                    },
                ]
            },
            {
                ...
                meta: {
                    icon: "BellFilled",
                    text: "Notification",   //通知管理
                    permissions: [PermissionChoices.Staff],  // 任何人都可以访问
                    opt: "|"
                },
                children: [
                    {
